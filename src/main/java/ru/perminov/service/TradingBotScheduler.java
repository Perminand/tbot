...
public class TradingBotScheduler {
    ...
    /**
     * Умный быстрый мониторинг каждые 15 минут (ЗАЩИТА ОТ OVERTRADING)
     * Использует умную стратегию анализа для выбора инструментов
     */
    @Scheduled(fixedRate = 900000) // 15 минут (УВЕЛИЧЕНО)
    public void smartQuickMonitoring() {
        log.info("Запуск умного быстрого мониторинга (15 мин)");
    ...
    /**
     * Умный полный мониторинг каждые 60 минут (ЗАЩИТА ОТ OVERTRADING)
     * Использует умную стратегию анализа для выбора инструментов
     */
    @Scheduled(fixedRate = 3600000) // 60 минут (УВЕЛИЧЕНО)
    public void smartFullMonitoring() {
        log.info("Запуск умного полного мониторинга (60 мин)");
